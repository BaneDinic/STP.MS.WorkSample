(function () {
    ...
    ko.simpleGrid = {
        ...
        viewModel: function (configuration) {
            ...
            this.manualMaxIndex = ko.observable(0);

            this.maxPageIndex = ko.computed(function () {
                if (this.manualMaxIndex() > 0) {
                    return this.manualMaxIndex();
                }
                else {
            ...
            this.requestFunction = configuration.requestFunction;
        }
    };
    ...
    templateEngine.addTemplate("ko_simpleGrid_pageLinks", "\
                    <div class=\"ko-grid-pageLinks\">\
                        ...
                        <!-- ko foreach: ko.utils.range(0, maxPageIndex) -->\
                               <a href=\"#\" data-bind=\"text: $data + 1, click: function() { $root.currentPageIndex($data); $root.requestFunction() }, css: { selected: $data == $root.currentPageIndex() }\">\
                            </a>\
                        <!-- /ko -->\
                    </div>");
